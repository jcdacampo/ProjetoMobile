...
var ConfigPage = (function () {
    ...
    ConfigPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-config',template:/*ion-inline-start:"/home/jean/Projetos/Projetos Ionic/ProjetoMobile-master/src/pages/config/config.html"*/`<ion-header>\n    <ion-navbar>\n        <button ion-button menuToggle>\n    <ion-icon name="menu"></ion-icon>\n\n<button menu-toggle = "left" class = "button button-icon icon ion-navicon"></button>\n        </button>\n        <ion-title>Configurações</ion-title>\n    </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n    <h2>URL para banco de dados</h2>\n    <p>Insira o caminho especifico do seu banco de dados.</p>\n    <ion-input type="text" placeholder="URL://ServidorDeDados"></ion-input>\n    <button ion-button block>Salvar</button>\n</ion-content>`/*ion-inline-end:"/home/jean/Projetos/Projetos Ionic/ProjetoMobile-master/src/pages/config/config.html"*/,
        }),
...
var LoginPage = (function () {
    ...
    LoginPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["m" /* Component */])({
            selector: 'page-login',template:/*ion-inline-start:"/home/jean/Projetos/Projetos Ionic/ProjetoMobile-master/src/pages/login/login.html"*/`<ion-content padding class="login-page">\n\n    <ion-grid class="logo">\n        <ion-row>\n            <ion-col col-12>\n                <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/f/f3/Whole_Foods_Market_logo.svg/1280px-Whole_Foods_Market_logo.svg.png">\n            </ion-col>\n        </ion-row>\n    </ion-grid>\n\n    <ion-list>\n        <ion-item class="login usuario">\n            <ion-input name="nome" type="text" placeholder="Digite seu usuário"></ion-input>\n        </ion-item>\n        <ion-item class="login senha">\n            <ion-input name="senha" type="password" placeholder="Digite sua senha"></ion-input>\n        </ion-item>\n    </ion-list>\n\n    <button class="login entrar" ion-button block (click)="entrar()">Entrar</button>\n\n    <div text-center class="login esqueci-senha" (click)="esqueciSenha()">Esqueceu sua senha?</div>\n\n    <div text-center class="copyright">Version 1 Build 1.0.0</div>\n</ion-content>`/*ion-inline-end:"/home/jean/Projetos/Projetos Ionic/ProjetoMobile-master/src/pages/login/login.html"*/,
        }),
...
var ListPage = (function () {
    ...
    ListPage = ListPage_1 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-list',template:/*ion-inline-start:"/home/jean/Projetos/Projetos Ionic/ProjetoMobile-master/src/pages/list/list.html"*/`<ion-header>\n    <ion-navbar>\n        <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n        <ion-title>Detalhes</ion-title>\n    </ion-navbar>\n</ion-header>\n\n<ion-content>\n    <ion-list>\n        <button ion-item *ngFor="let item of items" (click)="itemTapped($event, item)">\n      <ion-icon [name]="item.icon" item-start></ion-icon>\n      {{item.title}}\n      <div class="item-note" item-end>\n        {{item.note}}\n      </div>\n    </button>\n    </ion-list>\n    <div *ngIf="selectedItem" padding>\n        You navigated here from <b>{{selectedItem.title}}</b>\n    </div>\n</ion-content>`/*ion-inline-end:"/home/jean/Projetos/Projetos Ionic/ProjetoMobile-master/src/pages/list/list.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavParams */]])
    ], ListPage);
    return ListPage;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__pages_list_list__ = __webpack_require__(154);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__pages_login_login__ = __webpack_require__(101);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__pages_config_config__ = __webpack_require__(100);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__pages_config_config__ = __webpack_require__(100);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_ionic_angular__ = __webpack_require__(27);
...
var MyApp = (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["m" /* Component */])({template:/*ion-inline-start:"/home/jean/Projetos/Projetos Ionic/ProjetoMobile-master/src/app/app.html"*/`<ion-menu [content]="content">\n  <ion-header>\n    <ion-toolbar>\n      <ion-title>Menu</ion-title>\n    </ion-toolbar>\n  </ion-header>\n\n  <ion-content>\n    <ion-list>\n      <button menuClose ion-item *ngFor="let p of pages" (click)="openPage(p)">\n        {{p.title}}\n      </button>\n    </ion-list>\n  </ion-content>\n\n</ion-menu>\n\n<!-- Disable swipe-to-go-back because it\'s poor UX to combine STGB with side menus -->\n<ion-nav [root]="rootPage" #content swipeBackEnabled="false"></ion-nav>`/*ion-inline-end:"/home/jean/Projetos/Projetos Ionic/ProjetoMobile-master/src/app/app.html"*/
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__list_list__ = __webpack_require__(154);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_ionic_angular__ = __webpack_require__(27);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
...
var HomePage = (function () {
    ...
    HomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["m" /* Component */])({
            selector: 'page-home',template:/*ion-inline-start:"/home/jean/Projetos/Projetos Ionic/ProjetoMobile-master/src/pages/home/home.html"*/`<ion-header>\n    <ion-navbar>\n        <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n\n<button menu-toggle = "left" class = "button button-icon icon ion-navicon"></button>\n        </button>\n        <ion-title>Produtos</ion-title>\n    </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n    <ion-searchbar></ion-searchbar>\n    <ion-list>\n        <button ion-item *ngFor="let item of items" (click)="itemTapped($event, item)">\n      <ion-icon [name]="item.icon" item-start></ion-icon>\n      {{item.title}}\n      <div class="item-note" item-end>\n        {{item.note}}\n      </div>\n    </button>\n    </ion-list>\n    <div *ngIf="selectedItem" padding>\n        <b>{{selectedItem.title}}</b>\n    </div>\n</ion-content>`/*ion-inline-end:"/home/jean/Projetos/Projetos Ionic/ProjetoMobile-master/src/pages/home/home.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2_ionic_angular__["f" /* NavController */], __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["g" /* NavParams */]])
    ], HomePage);
    return HomePage;
